        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
          ...
          >
            <div className="space-y-2">
              ...
              >
                 Full Stack Developer with 2 years of experience building scalable web applications using Spring Boot, Django, Next.js,  and AWS. Passionate about creating efficient backend systems and intuitive front-end interfaces to deliver high-performance, user-focused solutions.
            ...
            >
              ...
              <Button variant="outline" size="lg" asChild>
                <a 
                  href="/resume.pdf" 
                  download="Ritik_Kumar_Kehsri_Resume.pdf" 
                  target="_blank"                      
