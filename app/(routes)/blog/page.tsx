      ...
      <div className="container px-4 md:px-6 mx-auto">
        ...
        <div className="text-center text-muted-foreground">
          ...
          <div className="flex flex-wrap gap-2 justify-center mt-4">
            ...
            <span className="px-3 py-1 rounded-full bg-primary/10 text-primary text-xs">Software Development</span>
            <span className="px-3 py-1 rounded-full bg-primary/10 text-primary text-xs">Case Stidies</span>
            <span className="px-3 py-1 rounded-full bg-primary/10 text-primary text-xs">CTFs</span>
          </div>
        </div>
      </div>
    </section>
